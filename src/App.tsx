    ...
    <AnimatePresence mode="wait">
      {appLoading ? (
        <motion.div
          ...
          className="fixed inset-0 bg-[#0B0F17] flex flex-col items-center justify-center z-50 text-white font-sans selection:bg-emerald-500/30"
        >
          <div className="space-y-8 max-w-sm w-full px-6 flex flex-col justify-between h-96">
            <div className="flex flex-col items-center text-center space-y-4">
              <motion.div
                initial={{ scale: 0.8, opacity: 0 }}
                animate={{ scale: 1, opacity: 1 }}
                transition={{ delay: 0.1, duration: 0.4 }}
                className="p-4 bg-zinc-900 border border-zinc-800 text-emerald-400 rounded-3xl shadow-xl shrink-0 flex items-center justify-center mb-2"
              >
              ...
              >
                <h1 className="text-xl font-display font-medium text-white tracking-tight leading-none animate-pulse">
                  Personal Expense Tracker
                </h1>
                <p className="text-[10px] uppercase font-bold text-zinc-400 tracking-wider">Premium Finance Suite</p>
              </motion.div>
            </div>

            <div className="space-y-4">
              {/* Progress Tracker Slider bar */}
              <div className="h-1 w-full bg-zinc-800 overflow-hidden rounded-full relative">
                <motion.div
              ...
              <div className="text-center">
                <p className="text-[10px] font-mono tracking-widest text-zinc-500 uppercase font-bold animate-pulse">
                  Initializing Secure Ledger Environment...
                </p>
              </div>
            </div>

            <div className="flex items-center justify-center gap-1.5 text-[10px] text-zinc-600 font-mono">
              <ShieldCheck className="w-4 h-4 text-zinc-750" />
              <span>EXECUTIVE VAULT COMPLIANT</span>
            </div>
          </div>
        </motion.div>
      ) : (
        <motion.div
          ...
          className="min-h-screen bg-[#F8F9FA] text-zinc-800 antialiased font-sans flex flex-col justify-between"
        >
